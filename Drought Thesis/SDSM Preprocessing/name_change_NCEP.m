...
folder = 'F:\Research\Drought Thesis\Analysis\Bangladesh Data\NCEP\NCEP-DOE_BOX_034X_41Y\Standardized';
...
for k = 1:length(csv_files)
    ...
    csv_file = ['ncep', csv_file(1:4), 'gl.csv'];
    output_path = 'F:\Research\Drought Thesis\Analysis\SDSM\Processed Data\34x41 processed dat\NCEP';
